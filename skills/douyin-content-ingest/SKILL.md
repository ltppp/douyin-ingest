...
license: Apache-2.0
compatibility: Requires Python 3.12 and douyin-ingest 0.3.0 from https://github.com/ltppp/douyin-ingest.
metadata:
  version: "1.1.0"
...
```bash
python -m pip install 'douyin-ingest[agent] @ git+https://github.com/ltppp/douyin-ingest.git@v0.3.0'
```
